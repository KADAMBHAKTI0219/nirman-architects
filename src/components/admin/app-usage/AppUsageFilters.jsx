    ...
    <div className="bg-white p-4 rounded-2xl border border-slate-200/90 shadow-2xs flex flex-wrap items-end justify-between gap-4 relative">
      <div className="flex flex-wrap items-center gap-4 flex-1 min-w-[280px]">
        ...
        <div className="flex-1 min-w-[170px] space-y-1.5">
          ...
          <div className="relative">
            <select
              ...
              className="w-full px-3.5 py-2.5 bg-slate-50/60 border border-slate-200 rounded-xl text-xs font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 appearance-none pr-8 cursor-pointer"
            >
              {employees.length > 0 ? (
                employees.map(emp => (
        ...
        <div className="flex-1 min-w-[220px] space-y-1.5 relative">
          ...
          >
            <Calendar className="w-4.5 h-4.5 text-indigo-600 flex-shrink-0" />
            <div className="px-3 py-1 bg-indigo-50/80 border border-indigo-100 rounded-full text-slate-900 font-extrabold text-xs tracking-tight shadow-2xs">
            ...
            <div className="absolute left-0 top-16 bg-white border border-slate-200 rounded-2xl shadow-2xl z-30 p-4 w-80 space-y-3 animate-in fade-in duration-150">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs font-bold">
                <button
                  ...
                  className="px-2.5 py-1.5 bg-slate-50 hover:bg-indigo-50 text-slate-700 hover:text-indigo-600 rounded-lg text-[11px] border border-slate-200 text-left transition-all"
                >
                  Today
                </button>
                <button
                ...
                <button
                  ...
                  className="px-2.5 py-1.5 bg-indigo-50 text-indigo-700 rounded-lg text-[11px] border border-indigo-200 text-left font-extrabold"
                >
                  May 19 – May 25
                </button>
                <button
              ...
              <button
                ...
                className="w-full py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs rounded-xl shadow-xs transition-all flex items-center justify-center gap-1.5"
              >
