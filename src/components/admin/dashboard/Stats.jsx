    ...
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5">
      ...
      <div className="premium-stat-box p-5 flex flex-col justify-between h-36">
        ...
        <div className="flex items-center justify-between pt-1">
          ...
          <div className="flex items-center gap-1">
            <span className="text-[9px] font-black px-2 py-0.5 bg-sky-50 text-sky-600 rounded-full tracking-wider uppercase">Active Accounts</span>
          </div>
        </div>
      </div>
      ...
      <div className="premium-stat-box p-5 flex flex-col justify-between h-36">
        ...
        <div className="flex items-center justify-between pt-1">
          ...
          <div className="flex items-center gap-1">
            <span className="text-[9px] font-black px-2 py-0.5 bg-[#E5F0FA] text-[#2484C6] rounded-full tracking-wider uppercase">Live Rate</span>
          </div>
        </div>
      </div>
