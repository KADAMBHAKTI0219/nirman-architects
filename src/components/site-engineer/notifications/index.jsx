...
export default function Notifications() {
  ...
  const getCategory = (type) => {
    ...
    if (t.includes('CHAT') || t.includes('MESSAGE')) return 'client';
    return 'info';
  };
    ...
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="bg-white p-5 rounded-3xl border border-slate-100 shadow-2xs flex flex-wrap gap-4 items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <strong className="text-slate-855 text-sm block">Site Operations Alerts</strong>
            <span className="text-[10px] text-slate-400 block font-bold">Real-time geo-fence alerts, safety reports, and client request bulletins</span>
          </div>
        </div>
