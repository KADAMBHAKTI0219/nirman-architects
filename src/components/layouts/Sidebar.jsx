...
const SIDEBAR_ITEMS = {
  ...
  SiteEngineer: [
    ...
    { label: "Site & Client Updates", path: "/site-engineer/updates", icon: "FileText" },
    { label: "Assigned Tasks", path: "/site-engineer/tasks", icon: "CheckSquare" },
    { label: "Drawings & GFC", path: "/site-engineer/drawings", icon: "PenTool" },
