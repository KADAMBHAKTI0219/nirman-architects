...
/**
 * 25.10 POST /api/drawing-category/create
 * Creates a new drawing category record
 */
...
/**
 * 25.10 GET /api/drawing-category/active
 * Lists all active categories (Seeds default master categories if database is empty)
 */
