...
export default function Chat() {
  ...
  return (
    <div className="flex h-[calc(100vh-125px)] border border-slate-100 rounded-3xl overflow-hidden bg-white shadow-md animate-in fade-in duration-200">
      ...
      {/* 3. RIGHT SIDEBAR: CONTEXT DRAWER */}
      {showInfoDrawer && activeRoom && (
        <div className="w-72 border-l border-[#e9edef] flex flex-col shrink-0 bg-white overflow-y-auto scrollbar-thin animate-in slide-in-from-right duration-250">
          <div className="h-16 bg-[#f0f2f5] border-b border-[#e9edef] px-4 flex items-center gap-3 shrink-0">
            ...
            <span className="text-slate-900 font-bold text-xs">Channel Context</span>
          </div>

          <div className="p-4 space-y-5">
            {/* Project Info Block */}
            <div className="space-y-2">
              <span className="text-[9px] font-black text-slate-400 uppercase tracking-wider block">Project Info</span>
              <div className="p-3.5 bg-slate-50 border border-slate-100 rounded-2xl">
                <h5 className="font-bold text-xs text-slate-900 mb-1 leading-tight">{activeRoom.project}</h5>
                <p className="text-[11px] text-slate-600 font-normal leading-relaxed">
                  Commercial office tower project currently in active architectural planning and design validation.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <span className="text-[9px] font-black text-slate-400 uppercase tracking-wider block">
                Active Participants ({activeRoom.members?.length || 0})
              </span>
