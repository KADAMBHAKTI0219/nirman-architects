...
const drawingMarkingSchema = new mongoose.Schema({
  ...
  authorType:       { type: String, enum: ['EMPLOYEE', 'CLIENT_CONTACT'], required: true, default: 'EMPLOYEE' },
  authorId:         { type: mongoose.Schema.Types.ObjectId, required: true, refPath: 'authorModel' },
  authorModel:      { type: String, enum: ['User', 'ClientContact'], required: true, default: 'User' },
  markingType:      { 
    type: String, 
