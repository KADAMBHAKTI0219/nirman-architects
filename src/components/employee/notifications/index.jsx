      ...
      <div className="bg-white p-5 rounded-3xl border border-slate-100 shadow-2xs flex flex-wrap gap-4 items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-[10px] text-slate-400 block font-bold">Stay updated on task targets, drawing approvals, and shift punch states</span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 items-start">
        ...
        <div className="xl:col-span-2 space-y-6">
          ...
          {loading && alerts.length === 0 ? (
            <div className="bg-white p-8 rounded-3xl border border-slate-100 text-center text-xs font-bold text-slate-400">
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <span className="p-2.5 bg-white border border-slate-150 rounded-xl mt-0.5 shrink-0 shadow-3xs">
                          {renderCategoryIcon(getCategory(al.type))}
                        </span>
                        <div>
