          ...
          {filteredImages.map(img => {
            ...
            return (
              <div 
                ...
                className={`bg-white rounded-3xl border transition-all cursor-pointer overflow-hidden shadow-2xs group flex flex-col justify-between ${
                  isSel ? 'border-indigo-600 ring-2 ring-indigo-500/20' : 'border-slate-200/90 hover:border-indigo-300'
                }`}
              >
